...
Upstream implements a check on that executes the following code. Does not work well when migrating from scratch. [Issue #62](https://github.com/troessner/transitions/issues/62)
